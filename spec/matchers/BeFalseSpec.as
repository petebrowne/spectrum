package matchers {
	...
	public class BeFalseSpec extends Spec {
		...
		public function BeFalseSpec() {
			it('should match falses', function():void {
				expect(new BeFalse(false).match()).to(BeTrue);
			});
			
			it('should not match trues', function():void {
				expect(new BeFalse(true).match()).to(BeFalse);
			});
			
			it('should match empty strings', function():void {
			...
			it('should match 0s', function():void {
				expect(new BeFalse(0).match()).to(BeTrue);
			});
			
			it('should not match any number other than 0', function():void {
